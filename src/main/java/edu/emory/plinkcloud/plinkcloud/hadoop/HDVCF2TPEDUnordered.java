/*using random sampling for unsorted original input files and directly transform into TPED PLINK format*/
...
public class HDVCF2TPEDUnordered extends Configured implements Tool {
...
public static void main(String[] args) throws Exception{
	int code=ToolRunner.run(new HDVCF2TPEDUnordered(), args);
	System.exit(code);
}
