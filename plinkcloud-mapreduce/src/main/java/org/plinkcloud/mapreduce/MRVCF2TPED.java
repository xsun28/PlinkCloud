...
//			conf.setBoolean("mapreduce.map.speculative", false);                  // set in the configuration file
	...
	public static void main(String[] args) throws Exception{  //hadoop jar plinkcloud-mapreduce.jar org.plinkcloud.mapreduce.MRVCF2TPED /user/cloudera/VoTECloud/input/ /user/cloudera/VoTECloud/output/ 3 0.0001 1-2 true PASS //////-libjars lib/..jar,..jar
